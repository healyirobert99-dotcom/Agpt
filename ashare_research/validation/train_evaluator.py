...
from ashare_research.mining.reward import RewardResult, reward_from_metrics
...
class TrainEvaluator:
    ...
    def evaluate(self, expression: Expression) -> tuple[dict, RewardResult, str]:
        ...
        return result["metrics"], reward, str(result["run_dir"])
